...
/* build_single_sphere, a simple build function */
void World::build() {
  ...
  matte_ptr1->set_cd(blue);
  Sphere* sphere_ptr1 = new Sphere(Vector3d(0, 0, 0), 50);
  sphere_ptr1->set_color(blue);
  sphere_ptr1->set_material(matte_ptr1);
  add_object(sphere_ptr1);
}


/* build_shaded_spheres, a complex build function */
// void World::build() {
//   this->background_color = yellow;
